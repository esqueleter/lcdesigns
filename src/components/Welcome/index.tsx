  ...
  return (
   <>
        <Container id="home" fluid className={styles.welcome} >
          <Stack gap={5} className={`${styles.stack} d-flex col-md-4 mx-auto justify-content-center align-items-center`}> 
            ...
            <Link to="projects" spy={false} smooth={true} offset={-40} duration={200}>
